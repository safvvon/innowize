...
const servicesData: ServiceItem[] = [
  {
    ...
    description:
      'High-impact vertical video content designed to stop the scroll and drive engagement on Instagram.',
    features: [
      '15-60 second reels',
  ...
  },
  {
    ...
    description:
      'Compelling brand stories that communicate your values and connect with your audience emotionally.',
    features: [
      'Brand storytelling',
      'Product showcases',
  ...
  },
  {
    ...
    description:
      'Scroll-stopping content tailored for Instagram, Facebook, YouTube Shorts, and other platforms.',
    features: [
  ...
  },
  {
    ...
    description:
      'Dynamic product demonstrations that showcase features, benefits, and drive purchase decisions.',
    features: [
      'Product demos',
      'Unboxing videos',
      'Feature highlights',
  ...
  },
  {
    ...
    description:
      'Professional event documentation that preserves memories and creates shareable highlight content.',
    features: [
      'Live event filming',
      'Highlight reels',
      'Behind-the-scenes',
  ...
  },
  {
    ...
    description:
      'Strategic guidance to help you plan, create, and distribute video content that achieves your goals.',
    features: [
      'Content planning',
      'Audience analysis',
      'Platform strategy',
