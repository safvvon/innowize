...
export const About: React.FC<{ onOpenContact?: () => void }> = ({ onOpenContact }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E17] text-white overflow-hidden pt-28 pb-20">
      ...
      <section className="max-w-[1700px] w-full mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-8">
        <div className="bg-[#0F1628] border border-[#141A2B] rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full aspect-square max-w-md rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                <img
      ...
      <section className="max-w-[1700px] w-full mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-12">
        <div className="mb-8">
          <span className="text-[#60A5FA] text-xs font-poppins font-semibold tracking-[0.3em] uppercase mb-2 block">
            Our Foundation
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {pillars.map((pillar, idx) => (
            <motion.div
              ...
              className="bg-[#0F1628] border border-[#141A2B] hover:border-[#2563FF]/50 rounded-3xl p-8 sm:p-10 shadow-xl transition-all duration-500"
            >
      ...
      <section className="max-w-[1700px] w-full mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-10 md:p-14 rounded-3xl bg-[#0F1628] border border-[#141A2B] text-center shadow-xl">
          <div>
            <div className="text-5xl md:text-7xl font-black font-barlow text-white mb-2">
              87.2K
            </div>
