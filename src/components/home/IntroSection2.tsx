...
export const IntroSection2: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen w-full bg-beta flex items-center justify-center overflow-visible z-10 px-4 md:px-8 lg:px-16 py-12 md:py-20 pb-24 md:pb-32"
    >
      <div className="max-w-7xl w-full flex flex-col gap-4 md:gap-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-16">
          <div className="flex items-start">
            <h2
              ref={headingRef}
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-alpha"
            >
          ...
          <div className="flex flex-col justify-center gap-4 md:gap-5 text-xs md:text-sm lg:text-base">
            <p ref={textRef} className="text-alpha/80 leading-relaxed">
