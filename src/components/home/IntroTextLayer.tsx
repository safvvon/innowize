...
export const IntroTextLayer: React.FC = () => {
  ...
  const textStyle =
    'text-[16vw] lg:text-[15vw] leading-[0.65] lg:leading-[0.75] font-extrabold italic text-white/[0.08] uppercase font-barlow relative select-none whitespace-nowrap';

  return (
    <div
      ref={containerRef}
      className="flex absolute inset-0 z-30 flex-col justify-start mt-[8vh] pt-0 pointer-events-none overflow-hidden w-full max-w-full px-4 md:ml-0"
    >
      ...
      <div ref={r6} className="w-full flex justify-start pl-[2vw] will-change-transform">
        <span aria-hidden="true" className={textStyle}>experiences</span>
      </div>
      <div
        ref={r7}
